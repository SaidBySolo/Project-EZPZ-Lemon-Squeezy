...
class BotEmbed:
    ...
    #Sabin Embed setting
    Sabin = discord.Embed(
        title="Sabin", description="This Embed is a Profile of Sabin", color=0x569271)
    ...
    Sabin.add_field(name="Contact Information",
                    value="Discord : Sabin#9478", inline=False)
    Sabin.set_footer(text="Don't call me...." + str(now.year) + "년 " + str(now.month) + "월 " +
                    str(now.day) + "일 | " + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second))

    #SaidBySolo Embed setting
    SaidBySolo = discord.Embed(
        title="SaidBySolo", description="This Embed is a Profile of SaidBySolo", color=0x569271)
    SaidBySolo.set_author(name="Name : ")
    SaidBySolo.set_thumbnail(url="https://imgur.com/YBZEvFq.png")
    SaidBySolo.add_field(
        name="Position", value="Leader Developer", inline=False)
    ...
    Unoh03 = discord.Embed(
        title="Unoh03", description="This Embed is a Profile of Unoh03", color=0x569271)
    ...
    Unoh03.add_field(name="Contact Information",
                    value="Discord : Unoh03#6944", inline=False)
    Unoh03.set_footer(text="I'm not a developer!!" + str(now.year) + "년 " + str(now.month) +
                    "월 " + str(now.day) + "일 | " + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second))
    ...
    Dong9.add_field(name="Contact Information",
                    value="Discord : 김동규#0285", inline=False)
    Dong9.set_footer(text="." + str(now.year) + "년 " + str(now.month) + "월 " + str(
        now.day) + "일 | " + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second))

    #Decfcone1 Embed setting
    Decfcone1 = discord.Embed(
        title="Decfcone1", description="This Embed is a Profile of Decfcone1", color=0x569271)

    #JH Embed setting
    JH = discord.Embed(
        title="JH", description="This Embed is a Profile of JH", color=0x569271)

    #Huggy Embed setting
    Huggy = discord.Embed(
        title="Huggy", description="This Embed is a Profile of Huggy", color=0x569271)

    #help embed setting
    Helps = discord.Embed(title="Bot", color=0xffff80)
    Helps.set_author(name="EZPZ Lemon Squeezy",
                    icon_url="https://imgur.com/j0yodUO.png")
    ...
    Helps.add_field(
        name="연락처", value="Sabin : Sabin#9478 (많이 연락하지 마세요....)\nSaidBySolo : 라고솔로가말했습니다#1234", inline=False)
    ...
    #Vote1 Embed setting
    Vote1 = discord.Embed(title="투표를 생성하시겠습니까?",
                        description="생성자:", color=0x569271)
    Vote1.add_field(name="이모지에 반응하여주세요",
                    value=" :white_check_mark:생성\n:negative_squared_cross_mark:생성취소", inline=False)
    Vote1.set_footer(text="생성일시:" + str(now.year) + "년 " + str(now.month) + "월 " + str(
        now.day) + "일" + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second))

    #Vote2 Embed setting
    Vote2 = discord.Embed(title="제목을 입력해주세요.",
                        description="생성자:", color=0x569271)
    Vote2.set_footer(text="생성일시:" + str(now.year) + "년 " + str(now.month) + "월 " + str(
        now.day) + "일" + str(now.hour) + ":" + str(now.minute) + ":" + str(now.second))
