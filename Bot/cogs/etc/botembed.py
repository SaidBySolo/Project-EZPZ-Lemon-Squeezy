...
class BotEmbed:
    ...
    Helps3.add_field(name="히요비관련 명령어",value="히요비관련 명령어는 nsfw채널에러만 사용하실수있습니다.")
    Helps3.add_field(name="히요비검색", value="태그,제목으로 검색하실수있습니다.", inline=False)
    ...
    Helps3.add_field(name="날씨", value="현재 날씨를 네이버에서 크롤링 하여 가져옵니다.", inline=False)          
